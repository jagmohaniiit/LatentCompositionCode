...
baseReadDirectory=char(strcat(currentDirectory,'\ComparisonScores\VGGFace\'));
baseOutputDirectory=char(strcat(currentDirectory,'\VGGFace\CompositesProposedResults\'));
...
outputFilename=char(strcat(baseOutputDirectory,'Original',char(morphAttackGenerationTypes(ll)),'VGGFaceFMMPMRResults.txt'));
fw1 = fopen(outputFilename,'w');

outputFilename=char(strcat(baseOutputDirectory,'Original',char(morphAttackGenerationTypes(ll)),'VGGFaceFTAResults.txt'));
